// Data fetched from https://github.com/hyperreality/American-British-English-Translator/blob/master/data/british_spellings.json
// on 2023-09-17

use phf::{phf_map, Map};

static BRITISH_TO_AMERICAN_SPELLING: Map<&'static str, &'static str> = phf_map! {
...
/// Convert British to American spelling, if the mapping exists
pub fn americanise(word: &str) -> String {
...
mod test {
    ...
    #[test]
    fn test_americanise_falls_back_if_spelling_not_found() {
        let word = "foobar";

        assert_eq!(americanise(word), word);
    }

    #[test]
    fn test_americanise_returns_american_spelling_for_a_british_word() {
        let british = "accessorise";
        let american = "accessorize";

        assert_eq!(americanise(british), american);
    }
}
